...
const Proses = () => {
    return (
        <div id="problemDefinition" class="w-full h-full min-w-[475px] flex flex-col p-[50px] lg:px-[150px] xl:pt-0 xl:px-[200px]">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-base text-start mb-[50px] mt-[50px] text-hijau344E41">" dari analisis kompetitor yang sudah dilakukan, didapatkan kebutuhan informasi dan fitur yang ada di website e-commerce yang khusus menjual aplikasi "</span>
            </div>
            <div class="flex flex-col">
